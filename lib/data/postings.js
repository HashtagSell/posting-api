...
module.exports = function (app, es, self) {
	...
	self.aggregateByCategory = function (searchTerms, isFuzzy, callback) {
		if (typeof callback === 'undefined' && typeof isFuzzy === 'function') {
			callback = isFuzzy;
			isFuzzy = false;
		}
	...
	self.findSuggestedCategoryCodes = function (searchTerms, isFuzzy, callback) {
		if (typeof callback === 'undefined' && typeof isFuzzy === 'function') {
			callback = isFuzzy;
			isFuzzy = false;
		}
