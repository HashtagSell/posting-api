...
module.exports = function (app, self) {
	...
	self.findByQuestionId = function (postingId, questionId, includeDeleted, callback) {
		// verify case when includeDeleted is not supplied
		if (typeof callback === 'undefined' && typeof includeDeleted === 'function') {
		...
		if (typeof callback === 'undefined' &&
			typeof includeDeleted === 'undefined' &&
