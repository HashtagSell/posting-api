...
module.exports = function (app, models, self) {
	...
	router.delete('/:postingId/offers/:offerId', function (req, res, next) {
		models.offers.delete(req.body, function (err, offer) {
			if (err) {
				return next(err);
			}
	...
	router.get('/:postingId/offers/:offerId', function (req, res, next) {
		models.offers.findById(req.params.offerId, function (err, offer) {
			if (err) {
				return next(err);
			}
	...
	router.post('/:postingId/offers', function (req, res, next) {
		models.offers.create(req.body, function (err, offer) {
			if (err) {
				return next(err);
			}
	...
	router.post('/:postingId/questions', function (req, res, next) {
		models.questions.create(req.body, function (err, question) {
			if (err) {
				return next(err);
			}
