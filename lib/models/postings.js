...
module.exports = function (app, data, services, self) {
	...
	function mapPosting (originalPosting) {
		...
		// defaulting to source when no username is known
		posting.username = originalPosting.username || posting.external.source;

		// apply category as appropriate
		posting.categoryCode = posting.categoryCode || originalPosting.category;
